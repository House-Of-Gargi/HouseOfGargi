  ...
  return (
    <>
      <div className="category-banner">
        <img src="/images/size_guide_banner.png" alt="Tailor's measuring tape on silk" />
          ...
          <ScrollReveal>
            <div className="story-split">
              <div className="story-split__image">
                <img src="/images/size_guide_split.png" alt="Tailoring measurements" />
              </div>
              <div className="story-split__copy">
                <h2 style={{ color: 'var(--maharani-maroon)' }}>Standard Size Chart</h2>
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          <ScrollReveal>
            ...
            <div style={{ textAlign: 'center', marginTop: '40px' }}>
              <h2 style={{ color: 'var(--maharani-maroon)', marginBottom: '16px' }}>Need Custom Measurements?</h2>
              <p style={{ color: 'var(--stone-taupe)', marginBottom: '32px' }}>Explore our bespoke service for made-to-measure royal ensembles.</p>
              <Link href="/bespoke" className="btn btn--primary">Request Bespoke Fitting</Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
