  ...
  return (
    <>
      <div className="category-banner">
        <img src="/images/shipping_banner.png" alt="Premium packaging" />
          ...
          <ScrollReveal>
            <div className="story-split">
              <div className="story-split__image">
                <img src="/images/shipping_split.png" alt="Carefully wrapping a garment" />
              </div>
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          <ScrollReveal>
            ...
            <div style={{ textAlign: 'center', marginTop: '40px' }}>
              ...
              <Link href="/faq" className="btn btn--outline">Read FAQs</Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
