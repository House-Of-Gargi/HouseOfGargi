  ...
  return (
    <>
      <div className="category-banner">
        <img src="/images/sustainability_banner.png" alt="Natural dyes and sustainable practices" />
          ...
          <ScrollReveal>
            <div className="story-split">
              <div className="story-split__image">
                <img src="/images/sustainability_split.png" alt="Raw organic cotton" />
              </div>
        ...
        <div className="container" style={{ maxWidth: '800px' }}>
          <ScrollReveal>
            ...
            <div style={{ textAlign: 'center', marginTop: '40px' }}>
              ...
              <Link href="/shop" className="btn btn--primary">View Collection</Link>
            </div>
          </ScrollReveal>
        </div>
      </section>
